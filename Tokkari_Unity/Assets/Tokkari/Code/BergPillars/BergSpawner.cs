...
public class BergSpawner : MonoBehaviour
{
    ...
    public List<GameObject> iceBergs = new List<GameObject>(); //new string list for the iceBergs
    ...
    void Update()
    {
        if(timer > timeDelay) //if timer exceeds delay then spawn
        {
            SpawnBerg();
            timer = 0;
        }
